...
section1_progress = "slow"
is_done = false
hours_taken = 8

puts "Saba's section 1 progress has been #{section1_progress}, and despite having
  spent #{hours_taken} hours so far, his initial assumption that he would be done
  by now, has proven #{is_done}!"
